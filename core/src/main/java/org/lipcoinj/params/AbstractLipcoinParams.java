...
import org.lipcoinj.core.AltcoinNetworkParameters;
import org.lipcoinj.core.AltcoinSerializer;
 ...
 */
public abstract class AbstractLipcoinParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the LIPC denomination. */
    public static final MonetaryFormat LIPC;
    /** Standard format for the mLIPC denomination. */
    public static final MonetaryFormat MLIPC;
    /** Standard format for the Liptoshi denomination. */
    public static final MonetaryFormat LIPTOSHI;

    public static final int LIPC_TARGET_TIMESPAN = (int) (7 * 24 * 60 * 60); // 7 days
    public static final int LIPC_TARGET_SPACING = (int) (1.5 * 60); // 1.5 minutes
    public static final int LIPC_INTERVAL = LIPC_TARGET_TIMESPAN / LIPC_TARGET_SPACING;

    /**
     * The maximum number of coins to be generated
     */
    public static final long MAX_LIPCOINS = 300000000; // TODO: Needs to be 300 MILLIONS

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_LIPCOIN_MONEY = COIN.multiply(MAX_LIPCOINS);

    /** Currency code for base 1 Lipcoin. */
    public static final String CODE_LIPC = "LIPC";
    /** Currency code for base 1/1,000 Lipcoin. */
    public static final String CODE_MLIPC = "mLIPC";
    /** Currency code for base 1/100,000,000 Lipcoin. */
    public static final String CODE_LIPTOSHI = "Liptoshi";

    static {
        LIPC = MonetaryFormat.BTC.noCode()
            .code(0, CODE_LIPC)
            .code(3, CODE_MLIPC)
            .code(7, CODE_LIPTOSHI);
        MLIPC = LIPC.shift(3).minDecimals(2).optionalDecimals(2);
        LIPTOSHI = LIPC.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_LIPC_MAINNET = "org.lipcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_LIPC_TESTNET = "org.lipcoin.test";
    /** The string returned by getId() for regtest. */
    public static final String ID_LIPC_REGTEST = "regtest";

    public static final int LIPCOIN_PROTOCOL_VERSION_MINIMUM = 170000;
    public static final int LIPCOIN_PROTOCOL_VERSION_CURRENT = 170001;

    private static final Coin BASE_SUBSIDY = COIN.multiply(200);

    protected Logger log = LoggerFactory.getLogger(AbstractLipcoinParams.class);

    public AbstractLipcoinParams() {
        super();
        interval = LIPC_INTERVAL;
        targetTimespan = LIPC_TARGET_TIMESPAN;
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return LIPCOIN_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return LIPCOIN_PROTOCOL_VERSION_MINIMUM;
        }
    }
