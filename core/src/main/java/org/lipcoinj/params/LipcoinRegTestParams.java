 ...
 */
public class LipcoinRegTestParams extends LipcoinTestNet3Params {
    ...
    public Block getGenesisBlock() {
        synchronized (LipcoinRegTestParams.class) {
            if (genesis == null) {
    ...
    private static LipcoinRegTestParams instance;

    public static synchronized LipcoinRegTestParams get() {
        if (instance == null) {
            instance = new LipcoinRegTestParams();
        }
        return instance;
    }
