...
package com.lipcoin.lipcoinj.protocols.payments;
...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/vnd.lipc.payment.request";
    public static final String MIMETYPE_PAYMENT = "application/vnd.lipc.payment.payment";
    public static final String MIMETYPE_PAYMENTACK = "application/vnd.lipc.payment.ack";
